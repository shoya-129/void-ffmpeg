...
#define FFMPEG_CONFIGURATION "--cc=emcc --cxx=em++ --ar=emar --nm=emnm --ranlib=emranlib --target-os=none --arch=x86_32 --enable-cross-compile --disable-x86asm --disable-inline-asm --disable-stripping --disable-programs --disable-doc --disable-debug --disable-runtime-cpudetect --enable-static --disable-shared --disable-pthreads --disable-w32threads --disable-os2threads --disable-network --disable-everything --enable-protocol=file --enable-demuxer='mov,mp4,m4a,3gp,3g2,mj2,matroska,ogg,wav,mp3' --enable-muxer='mp4,mov,matroska,ogg,wav,mp3' --enable-decoder='h264,hevc,vp8,vp9,mpeg4,aac,mp3,opus,vorbis,flac,pcm_s16le,mjpeg,png' --enable-encoder='aac,pcm_s16le,mjpeg,png' --enable-parser='h264,hevc,aac,mjpeg' --enable-avcodec --enable-avformat --enable-avutil --enable-swscale"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 6.0.3 (283e2d130132859fde6a4e4c87fd254b38127651)"
#define OS_NAME none
